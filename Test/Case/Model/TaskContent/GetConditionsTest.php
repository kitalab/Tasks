<?php
/**
 * TaskContent::getConditions()のテスト
 *
 ...
 */
class TaskContentGetConditionsTest extends WorkflowGetTest {
 ...
 */
	public function testGetConditions() {
		...
		//テスト実施
		$result = $this->$model->$methodName($blockId, $conditions);

		//チェック
		$this->assertEquals($blockId, $result['TaskContent.block_id']);
	}
}
