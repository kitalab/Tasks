...
/**
 * getList() $userParamが設定されている場合のテスト
 *
 * @return void
 */
	public function testGetListUserParam() {
		$model = $this->_modelName;
		$methodName = $this->_methodName;
		...
		//チェック
		$this->assertNotEmpty($result);
		$this->assertEquals($userParam['TaskCharge.user_id'], $result[0]['TaskContents'][0]['TaskCharge'][0]['user_id']);
	}

/**
 * getList() 設定した$userParamにデータがない場合のテスト
 *
 * @return void
 */
	public function testGetListUserParamNull() {
		$model = $this->_modelName;
		$methodName = $this->_methodName;
